...
def question2():
    ...
    game.show_long_text("How many toes does a cat have?", DialogLayout.BOTTOM)
    blockMenu.set_controls_enabled(True)
    blockMenu.show_menu(["16", "18", "20", "22"],
        MenuStyle.GRID,
        MenuLocation.FULL_SCREEN)

def on_on_overlap(sprite, otherSprite):
    global q1cartoon, q1cat
    sprites.destroy_all_sprites_of_kind(SpriteKind.player)
    sprites.destroy_all_sprites_of_kind(SpriteKind.trivia)
    if otherSprite == cartoonTrivia:
        q1cartoon = 1
        questionOne()
    elif otherSprite == catTrivia:
        q1cat = 1
        catTrivia.destroy()
        question2()
sprites.on_overlap(SpriteKind.player, SpriteKind.trivia, on_on_overlap)

def startGame():
    global mainCharacter, cartoonTrivia, catTrivia
    scene.set_background_image(img("""
    ...
    mainCharacter = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    mainCharacter.set_position(80, 61)
    controller.move_sprite(mainCharacter)
    mainCharacter.set_stay_in_screen(True)
    if q1cartoon == 0 and q1cat == 0:
        cartoonTrivia = sprites.create(img("""
            ...
            """),
            SpriteKind.trivia)
        cartoonTrivia.set_position(34, 84)
        catTrivia = sprites.create(img("""
            ...
            """),
            SpriteKind.trivia)
        catTrivia.set_position(124, 84)
    elif q1cartoon == 1 and q1cat == 0:
        catTrivia = sprites.create(img("""
                e e e . . . . e e e . . . . 
                            c d d c . . c d d c . . . . 
                            c b d d f f d d b c . . . . 
...
def questionOne():
    ...
    """))
    scene.set_background_color(1)
    game.show_long_text("Who is the main character of Infinity Train season 1?",
        DialogLayout.BOTTOM)
    blockMenu.set_controls_enabled(True)
    blockMenu.show_menu(["Alan Dracula", "Jesse", "Tulip Olsen", "Grace"],
        MenuStyle.GRID,
        MenuLocation.FULL_SCREEN)
...
catTrivia: Sprite = None
cartoonTrivia: Sprite = None
q1cat = 0
q1cartoon = 0
scene.set_background_image(img("""
